...
<form method="post" action="">
	<table>
		...
		<tbody>
			<tr>
				<td colspan="2">센터 이름 : <input type="text" name="centername" id="centername">
			</tr>
			<tr>
				<td>센터 주소 : <input type="text" size="50" name="centeraddr" id="centeraddr" placeholder="주소"></td>
    ...
    function sample5_execDaumPostcode() {
        new daum.Postcode({
            oncomplete: function(data) {
                ...
                // 주소 정보를 해당 필드에 넣는다.
                document.getElementById("centeraddr").value = fullAddr;
                // 주소로 좌표를 검색
